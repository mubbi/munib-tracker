 ...
 * Keep in sync with CORRUPTION_RE in `src/i18n/i18n-guard.test.ts`.
 */
const CORRUPT_RE =
  /pryer|erlier|lter pry|mнаth|Trcker|Thjjud|wилиship|Impилиt|Stилиe|begв|durвg|обновлениеd|сегодня's|t {2}glce|nme,|rr th|wилиld|mu'kkdh|frd pry|hэтоt|Trvell|Downlod|phнаe|slh|combвe|shилиten|dhkr к|sunnh|pused|ct из|trckвg|Fвd|directiна|JSна|Dtes|sttus|sttuses|qz rr|sel на|beдляe|rushвg|bck к|puse для|dys fsted|Suhoили|Iftr|Rmd|Dy |Fst |Lylt|odd ночь|strove hrdest|thousи|decdes|allhumm|pry Thjjud|аккаунт, sme|MYMEMORY WARNING|\byhs\b|bookmrked|hdith\b|\bdevam et\b|Fcebook|dvm et|dvom et|aetc devam|\bsecret\b.*\bnever\b|\bnever\b.*\b(add|ekle|tambah|qo'sh|добавить)\b|without review|Revэто|Revdiri|Revwiku|Revbuid|Revدی|mtched|serch\b|sved |behвd|behichidd|\bextr\b|ctch up|logAmountPlaceholder.:."yhs"|new yhs|old наes|old des|old кues|Cнаtвue|sii wd with|دوام with|[a-zA-Z][а-яА-ЯёЁ]|[а-яА-ЯёЁ][a-zA-Z]|[a-zA-Z][آ-ی]|[آ-ی][a-zA-Z]/i;
