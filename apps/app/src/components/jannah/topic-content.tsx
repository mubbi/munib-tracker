import type { JannahTopic } from "@munib-tracker/shared/types";
...
const IMPORTANCE_TONE: Record<
  NonNullable<JannahTopic["importance"]>,
...
export function JannahTopicContent({ topic }: { topic: JannahTopic }) {
