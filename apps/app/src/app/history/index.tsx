...
import { ensureIslamicHistoryContent, getIslamicHistoryEvents } from "@/lib/islamic-history";
...
export default function HistoryScreen() {
  ...
  const { version: contentVersion } = useEnsureContent(ensureIslamicHistoryContent);
