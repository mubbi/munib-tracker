...
/**
 * Islamic Finance — a purely educational introduction to the ethical framework
 * Islam brings to money: the prohibition of riba (interest/usury), the command
 * to trade fairly, the obligation of zakah, voluntary sadaqah, and the general
 * concept of takaful (cooperative risk-sharing). Deliberately out of scope:
 * fund screeners, ETF or stock lists, brokerage or product recommendations, and
 * rulings on specific modern financial products (mortgages, credit cards,
 * specific takaful providers) — those require a qualified, certified Islamic
 * finance scholar or institution reviewing your actual contract, not an app.
 * Every topic here is either a direct Qur'an/hadith citation (verified against
 * the standard printed editions on sunnah.com and the Sahih International
 * Qur'an translation) or clearly framed as general education, never a fatwa.
 * Bump the version whenever content changes.
 */
export const ISLAMIC_FINANCE_CONTENT_VERSION = 1;

export const ISLAMIC_FINANCE_SECTION_ORDER = [
  "principles",
  "riba",
  "trade",
  "giving",
...
export const ISLAMIC_FINANCE_TOPICS: LearnGuideTopic[] = [
  // ── Principles ───────────────────────────────────────────────────────────
  {
    id: "what-is-islamic-finance",
    section: "principles",
  ...
  {
    id: "why-trade-differs-from-interest",
    section: "riba",
  ...
  // ── Giving ───────────────────────────────────────────────────────────────
  {
    ...
    appLinks: [{ label: "Zakat guide and calculator", route: "/zakat" }],
  },
  {
    id: "sadaqah-voluntary-giving",
    section: "giving",
  ...
  // ── FAQ ──────────────────────────────────────────────────────────────────
  {
    id: "faq-is-this-financial-advice",
    section: "faq",
  ...
  {
    id: "faq-finding-compliant-options",
    section: "faq",
  ...
  {
    id: "faq-common-modern-questions",
    section: "faq",
