...
export const SEERAH_EVENTS_TR: DeepPartial<SeerahEvent>[] = [
  ...
  {
    title: "Hükümdarlara mektuplar",
    body: "Hudeybiye Antlaşması Müslümanlara savaştan bir soluklanma verince, Peygamber ﷺ dikkatini Arabistan'ın ötesine çevirdi. Hicretin 6-7. yıllarında güvendiği sahabeleri elçi olarak gönderdi; her biri mührüyle damgalanmış bir mektup taşıyordu ve o dönemin büyük hükümdarlarını İslam'a davet ediyordu: Bizans İmparatoru Herakleios; Pers İmparatoru II. Hüsrev; Bizans'ın Mısır valisi Mukavkıs; Müslüman muhacirleri daha önce barındırmış olan Habeşistan Necaşisi; ve Bahreyn ile Umman'ın hükümdarları.\n\nHerakleios'a yazılan mektup, hadis literatüründe neredeyse kelime kelime korunmuştur: 'Seni İslam'a davet ediyorum. İslam'ı kabul et, kurtulursun... İslam'ı kabul et, Allah sana iki kat mükâfat versin' (Sahih el-Buhari 7). Bu rivayet, Herakleios'un henüz Müslüman olmayan Mekkeli tacir Ebu Süfyan'a Peygamber'in ﷺ soyunu ve karakterini sorduğu uzun sohbeti de korumuştur; verilen dürüst cevaplardan bu özelliklerin gerçek bir peygambere uyduğu sonucuna varmış, ancak bu inancına göre hareket etmemiştir. Hüsrev ise siyer kaynaklarında mektubu öfkeyle yırttığı şekilde hatırlanır; Necaşi ise elçiyi büyük bir saygıyla karşılamıştır.\n\nDers: son Elçi'nin görevi Arabistan ile sınırlı değildi — Medine güvene kavuşunca çağrı, Kur'an'ın onu 'bütün insanlığa' gönderildiğini belirttiği gibi (Kur'an 34:28), bilinen tüm dünyaya yayıldı. Bazı hükümdarlar dürüstçe dinledi, bazıları nezaketle karşılık verdi, bazıları da kibirle — ve her tepki, krallıklarının İslam'la ileride nasıl karşılaşacağının bir işaretiydi.",
    location: "Medine",
  },
  {
    title: "Hayber seferi",
  ...
  {
    title: "Telafi Umresi (Umretü'l-Kaza)",
    body: "Hudeybiye Antlaşması, Müslümanları hicretin 6. yılında Umre'den geri çevirmiş, ancak ertesi yıl geri dönebilecekleri sözünü vermişti. Hicretin 7. yılının Zilkade ayında, tam da kararlaştırıldığı gibi, Peygamber ﷺ yaklaşık iki bin sahabeyle Mekke'ye geri döndü ve kendilerinden esirgenen ibadeti yerine getirdi — bu, Umretü'l-Kaza, yani 'telafi' Umresi olarak hatırlanır (bazı kaynaklarda Umretü'l-Kısas da denir).\n\nAntlaşmanın kendi tarafına sadık kalan Kureyş, Müslümanların ibadetlerini huzur içinde yerine getirmesi için şehri üç gün boyunca boşalttı; çevredeki tepelerden, bir zamanlar kovdukları topluluğun şimdi Kâbe'yi tam bir güven içinde tavaf ettiğini izlediler. Bu ziyaret sırasında Peygamber'in ﷺ amcası Abbas, onun Meymune bint el-Haris ile evliliğini düzenledi ve hacıların bağlılığını ve disiplinini gören bazı Mekkeliler açıkça duygulandı.\n\nDers: tutulan bir söz kendi başına bir davet biçimidir. Yirmi yıllık davetin ve savaşın yumuşatamadığı kalpleri, Hudeybiye'nin 'apaçık zaferinin' (Kur'an 48:1) doğrudan meyvesi olan tek bir barışçıl, onurlu Umre yumuşattı. Bu sessiz ziyaret, ertesi yıl Mekke'nin neredeyse kan dökülmeden teslim alınmasının zeminini hazırladı.",
    location: "Mekke",
  },
  {
  ...
  {
    title: "Huneyn Savaşı",
    body: "Mekke'nin barışçıl fethinden sadece haftalar sonra, Müslümanların ani yükselişinden tedirgin olan ve sonuna kadar savaşmaya kararlı Hevazin ve Sakif kabile birlikleri, ailelerini, sürülerini ve mallarını da yanlarına alarak büyük bir ordu topladılar ve Mekke ile Taif arasındaki dar Huneyn vadisinde Peygamber'in ﷺ çok daha büyük kuvvetiyle karşılaştılar.\n\nHevazin, geçitlere okçular saklamıştı ve şafak vakti ani bir ok yağmuru başlatınca Müslüman öncü birlikleri dağıldı; bir an için Müslümanların topladığı en büyük ordunun sadece bir baskınla bozguna uğrayacağı görüldü. Kur'an bu tam tersine dönüşü şöyle anlatır: '...ve Huneyn günü; hatırlayın, çokluğunuzla böbürlenmiştiniz, ama size hiçbir fayda vermemişti; yeryüzü bütün genişliğine rağmen size dar gelmiş, sonra da geri dönüp kaçmıştınız' (Kur'an 9:25). Peygamber'in ﷺ kendisi sebat etti ve amcası Abbas'a Ensar'ı ve Medine kabilelerini isimleriyle çağırmasını emretti; bu çağrıyla sahabeler geri döndü, saflarını yeniden topladı ve savaş, Kur'an'ın Allah'ın gönderdiği sükûnete ve görünmez yardıma bağladığı kesin bir Müslüman zaferine dönüştü (Kur'an 9:26).\n\nDers: sayı ve teçhizat bir savaşın sonucunu belirlemez — Bedir bunu küçük bir kuvvetle öğretmişti, Huneyn ise tam tersini öğretti: Allah'ın yardımı ve savaş alanı disiplini olmadan çok büyük bir ordu bile sarsılabilir. Sonrasında ele geçirilen büyük ganimet, kalpleri kazanmak amacıyla, yeni Müslüman olan Mekkelilere bile cömertçe dağıtıldı, biriktirilmek için değil.",
    location: "Huneyn",
  },
  {
    title: "Tebük seferi",
  ...
  {
    title: "Elçiler Yılı (Amü'l-Vüfud)",
    body: "Hicretin dokuzuncu yılında, Mekke'nin teslim olmasının ve Tebük'teki güç gösterisinin ardından, Arabistan kabileleri yeni düzene karşı çıkmanın artık gerçekçi olmadığını anladı. Bani Temim, Bani Amir, Yemen kabileleri ve daha birçoğundan gelen heyetler, İslam'ı kabul ettiklerini ve Peygamber'e ﷺ bağlılıklarını bildirmek için Medine'ye art arda geldi; bu kadar çoktu ki o yıl siyerde Amü'l-Vüfud, Elçiler Yılı olarak hatırlanır.\n\nPeygamber ﷺ her grubu misafirperverlikle ve sabırlı öğretimle karşıladı; onlara zorla hükmedecek valiler değil, halklarına Kur'an ve namazı öğretecek sahabeler gönderdi. Kur'an, Nasr Suresi'nde bu ana doğrudan işaret eder: 'Allah'ın yardımı ve fetih geldiğinde, insanları Allah'ın dinine akın akın girerken gördüğünde, Rabbini hamd ile tesbih et ve O'ndan mağfiret dile' (Kur'an 110:1-3) — sahabelerin, İbn Abbas'ın Ömer'e açıkladığı gibi, Peygamber'in ﷺ hayatının sonuna yaklaştığının bir işareti olarak anladığı bir sure (Sahih el-Buhari 4430).\n\nDers: mesajın onlarca yıl çoğunluk tarafından reddedilip azınlık tarafından kabul edildiği bir dönemden sonra, Allah'ın vaadi bir kerede geldi — sabrın ve başarıyı doğru okumanın bir dersi. Nasr Suresi'nin zafere verdiği karşılık kutlama değil, hamd ve istiğfardır; bir müminin hayatındaki her başarıyı nasıl karşılaması gerektiğine dair bir örnektir. Bu, arkasından gelen Veda Haccı'na zemin hazırlar.",
    location: "Medine",
  },
  {
    title: "Veda Haccı",
