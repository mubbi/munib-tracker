...
// Indonesian translation overlay for the Learn Battles content. Each overlay mirrors
...
export const BATTLES_TOPICS_ID: DeepPartial<BattlesTopic>[] = [
  // ── Context ───────────────────────────────────────────────────────────────
  {
    title: "Pengantar",
    ...
    appLinks: [{ label: "Garis Waktu Sirah" }, { label: "Garis Waktu Peperangan" }],
  },
  {
  ...
  },
  {
    ...
    appLinks: [{ label: "Ayat-Ayat Al-Qur'an" }],
  },
  ...
  // ── Battles during the Prophet ﷺ ──────────────────────────────────────────
  {
    ...
    appLinks: [{ label: "Ayat-Ayat tentang Badar" }, { label: "Tokoh-Tokoh Penting" }],
  },
  {
    title: "Perang Uhud",
    ...
    appLinks: [{ label: "Pelajaran Kepemimpinan" }, { label: "Tokoh-Tokoh Penting" }],
  },
  {
    ...
    appLinks: [{ label: "Salman al-Farisi" }],
  },
  {
  ...
  },
  {
    ...
    appLinks: [
      { label: "Pelajaran: Kesabaran Sebelum Kemenangan" },
      { label: "Ayat-Ayat Al-Qur'an" },
    ],
  },
  {
    ...
    appLinks: [{ label: "Ali bin Abi Thalib" }],
  },
  {
    title: "Perang Mu'tah",
    ...
    appLinks: [{ label: "Khalid bin Walid" }],
  },
  {
    ...
    appLinks: [{ label: "Pelajaran: Rahmat Setelah Kemenangan" }],
  },
  {
    title: "Perang Hunain",
    summary:
    ...
    appLinks: [{ label: "Pelajaran: Kerendahan Hati dalam Kekuatan" }],
  },
  {
    title: "Perang Tabuk",
    ...
    appLinks: [{ label: "Pelajaran: Pengorbanan dan Ketulusan" }],
  },
  ...
  // ── Expeditions ───────────────────────────────────────────────────────────
  {
    ...
    appLinks: [{ label: "Glosarium" }, { label: "Garis Waktu" }],
  },
  ...
  // ── Wisdom ────────────────────────────────────────────────────────────────
  {
    ...
    appLinks: [{ label: "Kartu Pelajaran" }],
  },
  ...
  },
  {
    ...
    appLinks: [{ label: "Garis Waktu Sirah" }, { label: "Ayat-Ayat Al-Qur'an" }],
  },
];

// Post-prophetic battle details supplemental overlay (BATTLES_AFTER_PROPHET).
export const BATTLES_AFTER_PROPHET_ID: DeepPartial<{
  title: string;
  body: string;
  location: string;
}>[] = [
...
export const BATTLES_VERSES_ID: DeepPartial<BattlesVerse>[] = [
  {
    excerpt:
...
export const BATTLES_TIMELINE_ID: DeepPartial<BattlesTimelineEvent>[] = [
  {
    title: "Wahyu Pertama",
...
export const BATTLES_FIGURES_ID: DeepPartial<BattlesFigure>[] = [
  {
...
export const BATTLES_LESSON_CARDS_ID: DeepPartial<BattlesLessonCard>[] = [
  {
...
export const BATTLES_GLOSSARY_ID: DeepPartial<BattlesGlossaryTerm>[] = [
  {
    term: "Ghazwah",
    definition:
