...
export const QURAN_GUIDE_TOPICS_ID: DeepPartial<QuranGuideTopic>[] = [
  {
    title: "Pengantar",
    ...
    appLinks: [{ label: "Baca Al-Qur'an" }, { label: "Pelajaran harian" }],
  },
  {
    ...
    appLinks: [{ label: "Garis waktu wahyu" }, { label: "Sirah" }],
  },
  {
    ...
    appLinks: [{ label: "Visual struktur" }, { label: "Jelajahi surah" }],
  },
  {
    ...
    appLinks: [{ label: "Tingkat bacaan" }, { label: "Huruf Arab" }],
  },
  {
    title: "Tajwid",
    ...
    appLinks: [{ label: "Pelajaran tajwid" }],
  },
  {
    title: "Huruf Arab",
    ...
    appLinks: [{ label: "Penjelajah huruf" }, { label: "Panduan pelafalan" }],
  },
  {
    title: "Pelafalan",
    ...
    appLinks: [{ label: "Perbandingan huruf" }],
  },
  {
    ...
    appLinks: [{ label: "Daftar kosakata" }],
  },
  {
    title: "Tafsir",
    ...
    appLinks: [{ label: "Buka pembaca Al-Qur'an" }],
  },
  {
  ...
  },
  {
    ...
    appLinks: [{ label: "Rencana hafalan" }, { label: "Pelacak hifz" }],
  },
  {
    ...
    appLinks: [{ label: "Pelajaran hari ini" }],
  },
  {
    ...
    appLinks: [{ label: "Pertanyaan tadabbur" }, { label: "Jurnal" }],
  },
  {
    ...
    appLinks: [{ label: "Tantangan hari ini" }],
  },
  {
...
export const QURAN_GUIDE_STRUCTURE_LEVELS_ID: DeepPartial<QuranGuideStructureLevel>[] = [
  {
    label: "Al-Qur'an",
    count: "1 Kitab",
    detail:
...
export const QURAN_GUIDE_TIMELINE_ID: DeepPartial<QuranGuideTimelineEvent>[] = [
  {
...
export const QURAN_GUIDE_STORIES_ID: DeepPartial<QuranGuideStory>[] = [
  {
    prophetName: "Adam AS",
  ...
  },
  {
    ...
    appLinks: [{ label: "Garis waktu sirah" }],
  },
];

export const QURAN_GUIDE_THEMES_ID: DeepPartial<QuranGuideTheme>[] = [
  {
    title: "Iman",
    summary:
  ...
  },
  {
    ...
    appLinks: [{ label: "Perjalanan menuju surga" }],
  },
  {
    title: "Neraka",
    summary:
...
export const QURAN_GUIDE_TAJWEED_ID: DeepPartial<QuranGuideTajweedLesson>[] = [
  {
...
export const QURAN_GUIDE_VOCABULARY_ID: DeepPartial<QuranGuideVocabEntry>[] = [
  {
    meaning:
...
export const QURAN_GUIDE_LETTERS_ID: DeepPartial<QuranGuideLetter>[] = [
  {
    name: "Alif",
...
export const QURAN_GUIDE_PRONUNCIATION_ID: DeepPartial<QuranGuidePronunciationPair>[] = [
  {
    title: "Ain vs Ha",
...
export const QURAN_GUIDE_MEMORIZATION_PLANS_ID: DeepPartial<QuranGuideMemorizationPlan>[] = [
  {
...
export const QURAN_GUIDE_DAILY_LESSONS_ID: DeepPartial<QuranGuideDailyLesson>[] = [
  {
    translation:
      "Hai orang-orang yang beriman, jadikanlah sabar dan shalat sebagai penolongmu, sesungguhnya Allah beserta orang-orang yang sabar.",
    context:
...
export const QURAN_GUIDE_APPLY_CHALLENGES_ID: DeepPartial<QuranGuideApplyChallenge>[] = [
  {
...
export const QURAN_GUIDE_TADABBUR_PROMPTS_ID: DeepPartial<QuranGuideTadabburPrompt>[] = [
  {
...
export const QURAN_GUIDE_READING_LEVELS_ID: DeepPartial<QuranGuideReadingLevel>[] = [
  {
    title: "Alfabet Arab",
    summary:
...
export const QURAN_GUIDE_QUIZ_ID: DeepPartial<QuranGuideQuizQuestion>[] = [
  {
