...
export const LAST_DAY_TOPICS: LastDayTopic[] = [
  ...
  // ── Practice ───────────────────────────────────────────────────────────────
  {
    ...
    body: [
      ...
      "Build the day on the pillars the texts made heavy on the Scale. Salah on time is the anchor and the light of the Sirat. The Qur'an — recited, heard, and reflected on, even a few verses daily — keeps the heart alive. Tawbah clears the record: 'O believers, turn to Allah in sincere repentance' (Qur'an 66:8). Charity purifies wealth and outlives you as sadaqah jariyah. Dhikr keeps the tongue heavy on the Scale with words light on the tongue. And good character, the Prophet ﷺ said, is the heaviest thing placed on the Scale.",
      ...
      "Everything rests on one intention, stated in the first hadith of Sahih al-Bukhari: 'Actions are but by intentions.' Use Munib's trackers not as a score to compete over but as gentle scaffolding for these habits — prayer, Qur'an, dhikr, charity, repentance — each one quietly pointing your day toward the meeting with Allah. That is the whole aim: to live now as someone who truly expects to stand before Him.",
    ],
    quran: [
      {
        surah: 51,
